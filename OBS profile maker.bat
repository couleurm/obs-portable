...
echo cd "%homedrive%%homepath%\Documents\obs-portable-main\OBS\bin\64bit">>%localappdata%\Microsoft\WindowsApps\PRB.bat
...
::Launching OBS
cd "%homedrive%%homepath%\Documents\obs-portable-main\OBS\bin\64bit"
